...
import com.bisttrading.entity.trading.enums.*;
...
@Table(name = "orders", indexes = {
    ...
    @Index(name = "idx_orders_account_id", columnList = "account_id, created_at"),
    @Index(name = "idx_orders_symbol_id", columnList = "symbol_id, created_at"),
    @Index(name = "idx_orders_status", columnList = "order_status, created_at"),
    ...
    @Index(name = "idx_orders_user_status", columnList = "user_id, order_status, created_at"),
